...
//  };
  const goAttendance = (courseName) => {
    navigate(`/dashboard/attendance?courseName=${courseName}`);
  };
  const goGrade = (courseName) => {
    navigate(`/dashboard/grade?courseName=${courseName}`);
  };
  const goRanking = () => {
                ...
                <TableBody>
                  {list.map((row) => (
                    <TableRow>
                      ...
                      <TableCell align='center'>
			   <Button onClick={() => goAttendance(row.courseName)}>확인</Button>
                      </TableCell>
                      <TableCell align='center'>
		      	   <Button onClick={() => goGrade(row.courseName)}>확인</Button>
		      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
